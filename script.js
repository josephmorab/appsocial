const urlBase = 'https://jsonplaceholder.typicode.com/posts' // Esta es la url con la que interectuaremos
let posts = [] // Iniciamos con un array vacio donde estaran los posteos 
...
function postData(){
    ...
    .catch(error => console.log('Error al querer crear posteo ', error))
}
